                ...
                <div class="flex gap-2 items-center">
                    ...
                    <div class="w-full flex items-center flex-wrap gap-2">
                        ...
                        <div class="flex items-center">
                            <input id="{{ $category->name }}" type="checkbox" value="{{ $category->id }}" name="categories[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" @if(in_array($category->id, $categoryIds)) checked @endif>
